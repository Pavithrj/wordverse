...
const HeroSection = () => {
    return (
        <header id="hero" className="flex flex-col items-center justify-center min-h-screen gap-4 px-6 py-16 mx-auto text-center max-w-7xl">
            ...
            <Link to="/wordverse/blogs" aria-label="Explore WordVerse blogs" className="px-6 py-3 text-white transition duration-300 bg-orange-500 shadow w-fit rounded-xl hover:bg-orange-600">
                Explore Blogs
            </Link>
        </header>
    )
